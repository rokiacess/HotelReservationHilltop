	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<div class = "alert alert-info" style = "background-color:#212020;">Transaction / Room / Add Room</div>
				<br />
				<div class = "col-md-4">	
					<form method = "POST" enctype = "multipart/form-data">
						<div class = "form-group">
							...
							<select class = "form-control" required = required name = "room_type">
								...
								<option value = "Panovilla">Panovilla</option>
								<option value = "Buena Bista">Buena Bista</option>
								<option value = "Pano Verde">Pano Verde</option>
