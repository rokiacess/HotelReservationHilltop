	...
	<div class = "container-fluid">	
		<div class = "panel panel-default">
			...
			<div class = "panel-body">
				...
				<a href="archive.php" class="pull-right"> <i class = "fa fa-archive" title="Archive"  style="font-size:48px;color:red"></i></a>
				<br />
				<br />
				<table id = "table" class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo "₱.".$fetch['sub_total']?></td>
							<td><?php echo $fetch['status_bill']?></td>
							<td><?php if($fetch['discount'] == "0"){ echo "None";} else {echo $fetch['discount'];}?></td>
							<td><center><a class = "btn btn-warning" href = "checkout_query.php?transaction_id=<?php echo $fetch['transaction_id']?>" onclick = "confirmationCheckin(); return false;"><i class = "glyphicon glyphicon-ok" title ="Check out"></i></a>
							<a class="btn btn-success"href="Edit2.php?transaction_id=<?php echo $fetch['transaction_id']?>"><i class = "glyphicon glyphicon-edit" title = "Edit"></i></a>
							<a class = "btn btn-danger" onclick = "confirmationDelete(); return false;" href = "delete_pending.php?transaction_id=<?php echo $fetch['transaction_id']?>"><i class = "glyphicon glyphicon-trash" title = "Cancel"></i></a>
							<a class="btn btn-primary"href="Edit.php?transaction_id=<?php echo $fetch['transaction_id']?>"><i class="glyphicon glyphicon-credit-card" title = "Check Payment"></i></a>
							<a class = "btn btn-info" name="archive"  onclick="archiveFunction(); return false;" href = "archive_query.php?guest_id=<?php echo $fetch['guest_id']?>&transaction_id=<?php echo $fetch['transaction_id']?> "><i class = "fa fa-archive" title="Archive" ></i></a>
						</center></td>
						</tr>
						<?php
							}
