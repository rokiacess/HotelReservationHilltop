				...
				<table id = "table" class = "table table-striped" action="save">
					...
					<tbody>
						...
						<tr>
							...
							<td><center><a class = "btn btn-success" href = "confirm_reserve.php?transaction_id=<?php echo $fetch['transaction_id']?>"><i class = "glyphicon glyphicon-check" title="Check In"></i></a>
							<a class = "btn btn-danger" onclick = "confirmationDelete(); return false;" href = "delete_pending.php?transaction_id=<?php echo $fetch['transaction_id']?>"><i class = "glyphicon glyphicon-trash" title=" Discard"></i></a>
							<a class="btn btn-primary"href="view1.php?transaction_id=<?php echo $fetch['transaction_id']?>"><i class = "fa fa-eye" title="view"></i></a>
							<a class = "btn btn-info" name="archive"  onclick="archiveFunction(); return false;" href = "archive_query.php?guest_id=<?php echo $fetch['guest_id']?>&transaction_id=<?php echo $fetch['transaction_id']?> "><i class = "fa fa-archive" title="Archive" ></i></a></td>
						</tr>
						<?php
							}
						?>
...
<!--------archive function
<script>
function archiveFunction(anchor) {
...
function(isConfirm){
  if (isConfirm) {
    window.location = anchor.attr("archive.php");          // submitting the form when user press yes
  } else {
